    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carnival_day', models.BooleanField(default=False, verbose_name='carnival day')),
                ('carnival_date', models.DateField(default=datetime.date(2023, 2, 21), verbose_name='carnival date')),
                ('valentine_day', models.BooleanField(default=False, verbose_name='valentine day')),
                ('valentine_date', models.DateField(default=datetime.date(2023, 2, 14), verbose_name='valentine date')),
            ],
            options={
